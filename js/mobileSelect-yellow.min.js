...
(function() {
	...
	MobileSelect.prototype = {
		...
		init: function(config) {
            ...
            _this.floorText = config.floor || "";
			_this.connector = config.connector || " ";
			_this.triggerDisplayData = !(typeof(config.triggerDisplayData) == "undefined") ? config.triggerDisplayData : true;
			_this.trigger.style.cursor = "pointer";
			_this.setStyle(config);
			_this.setTitle(_this.titleText);
            _this.setFloor(_this.floorText);
			_this.checkIsPC();
			_this.checkCascade();
        ...
        setFloor: function(string) {
            var _this = this;
            _this.floorText = string;
            _this.mobileSelect.querySelector(".selectLine").innerHTML = _this.floorText
        },
		...
		renderWheels: function(wheelsData, cancelBtnText, ensureBtnText) {
			...
			_this.mobileSelect.innerHTML = '<div class="grayLayer"></div>' + '<div class="content">' + '<div class="btnBar">' + '<div class="fixWidth">' + '<div style="display: none" class="cancel">' + cancelText + "</div>" + '<div class="title title-yellow"></div>' + "</div>" + "</div>" + '<div class="panel">' + '<div class="fixWidth">' + '<div class="wheels">' + "</div>" + '<div class="selectLine"></div>' + '<div class="shadowMask"></div>' + "</div>" + "</div>" + '<div class="toward-dater toward-dater-yellow ensure">' + ensureText + "</div>" + "</div>";
