...
(function() {
	...
	MobileSelect.prototype = {
		...
		renderWheels: function(wheelsData, cancelBtnText, ensureBtnText) {
			...
			_this.mobileSelect.innerHTML = '<div class="grayLayer"></div>' + '<div class="content">' + '<div class="btnBar">' + '<div class="fixWidth">' + '<div style="display: none" class="cancel">' + cancelText + "</div>" + '<div class="title title-blue"></div>' + "</div>" + "</div>" + '<div class="panel">' + '<div class="fixWidth">' + '<div class="wheels">' + "</div>" + '<div class="selectLine"></div>' + '<div class="shadowMask"></div>' + "</div>" + "</div>" + '<div class="toward-dater toward-dater-blue ensure">' + ensureText + "</div>" + "</div>";
